...
fresh = st.session_state["fetched_at"]
player_json = st.session_state["player_json"]
current_gw = st.session_state["current_gw"]
pl_teams_dict = st.session_state["pl_teams_dict"]
pl_teams_list = st.session_state["pl_teams_list"]
position_dict = st.session_state["position_dict"]
status_dict = st.session_state["status_dict"]
player_df = st.session_state["player_df"]
fixtures_df = st.session_state["fixtures_df"]
fixtures_database = st.session_state["fixtures_database"]
fixture_col_defs = st.session_state["fixture_col_defs"]
fdr_database = st.session_state["fdr_database"]
fdr_avg_coldefs = st.session_state["fdr_avg_coldefs"]
team_fdr_rating_df = st.session_state["team_fdr_rating_df"]
pl_table_df = st.session_state["pl_table_df"]
pl_table_col_defs = st.session_state["pl_table_col_defs"]
dreamteam_df = st.session_state["dreamteam_df"]
dt_col_defs = st.session_state["dt_col_defs"]
top_price_risers_df = st.session_state["top_price_risers_df"]
pi_col_defs = st.session_state["pi_col_defs"]
top_price_fallers_df = st.session_state["top_price_fallers_df"]
pd_col_defs = st.session_state["pd_col_defs"]
